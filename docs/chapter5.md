...
中間発表では，「亀田支所前～はこだて未来大学間における一部路線の快速バス化による混雑分散効果」をテーマとして，数理モデリングの進捗報告を行った．発表では，はじめに数理モデリングとは何かを説明したうえで，第1章で述べた背景と課題，および第4章で述べた快速化・2周運行という解決策の方針を紹介した．そのうえで，バス乗客の選択行動や停留所でのタイムロスを動的に捉えるため，シミュレーションによるアプローチを採用することを示した．
